<html>
    <head>
        ...
        <title>Hotel Employee Register</title>
    </head>
    ...
    <?php
        ...
        if (isset( $_POST['save'] ))
        {
                ...
                $zip = $_POST['izip'];
                $salary = $_POST['isalary'];
                $role = $_POST['irole'];

            $dbconn = pg_connect($conn_string) or die('Connection failed');

            $query = "INSERT INTO public.employee(sin_number, hotel_ID, first_name, middle_name, last_name, country, state_or_province, city, street_number, street_name, apt_number, zip, salary, role) VALUES ('$sin','$hotelid','$firstname','$middlename','$lastname','$country','$stateorprovince','$city','$streetnumber','$streetname','$aptnumber','$zip','$salary','$role')";
    ...
    <body>
        <div id="header"> EMPLOYEE REGISTRATION FORM</div>
        <form id="testform" name="testform" method="POST" action="">
            <p> <label for="isin">SIN:</label>
                    <input name="isin" type="number" id="sin" min=100000000 max=999999999 required/>
            </p>

            <p> <label for="ihotelid">Hotel ID:</label>
                    <input name="ihotelid" type="number" id="ihotelid" required/>
            </p>
            ...
            <p> <label for="isalary">Salary:</label>
                    <input name="isalary" type="number" id="isalary" placeholder="Format: 34000" required/>
            </p>

            <p> <label for="irole">Role:</label>
                    <input name="irole" type="text" id="irole" required/>
            </p>
